...
hi Folded       ctermfg=blue    guifg=#eeeeee ctermbg=none    guibg=#5f5f87
...
hi SpecialKey   ctermfg=240     guifg=#5fdf5f
hi StatusLine   ctermfg=16                    ctermbg=12      guibg=#4e4e4e cterm=bold      gui=bold
...
hi Conceal                                    ctermbg=none    guibg=bg
...
""" vimdiff
hi diffAdd      ctermfg=none    guifg=fg      ctermbg=61      guibg=#afdfaf
"hi diffDelete   ctermfg=none    guifg=none    ctermbg=186     guibg=#dfdf87 cterm=none      gui=none
hi diffDelete   ctermfg=none    guifg=fg      ctermbg=246     guibg=#949494 cterm=none      gui=none
hi diffChange   ctermfg=none    guifg=fg      ctermbg=97      guibg=#dfafaf
hi diffText     ctermfg=none    guifg=fg      ctermbg=163     guibg=#df8787 cterm=none      gui=none
